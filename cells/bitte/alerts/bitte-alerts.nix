    ...
    rules = [
      {
        ...
        annotations = {
          ...
          summary =
            "[Consul] ACL Resolves alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          ...
          summary =
            "[Consul] Catalog Deregistration alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description = ''
            Average catalog registration operations on {{ $labels.host }} over the past 1 hour is > 10.
             The consul servers may be overloaded or not functioning correctly.'';
          summary =
            "[Consul] Catalog Registration alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          ...
          summary =
            "[Consul] Core Node Memory Utilization alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description = ''
            Average key-value store commit time on {{ $labels.host }} over the past hour is > 20 ms.
             The consul servers may be overloaded or not functioning correctly.'';
          summary =
            "[Consul] KVs apply alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Leadership contact latency is exceedingly high (> 200 ms) for host {{ $labels.host }}. The consul cluster may be degraded.";
          summary =
            "[Consul] Raft Leader Last Contact alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Average raft apply time on {{ $labels.host }} over the past hour is > 20 ms. The consul servers may be overloaded or not functioning correctly.";
          summary =
            "[Consul] Raft Apply alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Average raft commit time over the past hour on {{ $labels.host }} is > 20 ms. The consul servers may be overloaded or not functioning correctly.";
          summary =
            "[Consul] Raft Commit Time alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "There has been more than one raft election change in the past hour. Leadership may be flapping.";
          summary =
            "[Consul] Raft Elections alert";
        };
      }
      {
        ...
        annotations = {
          description =
            "There has been more than one raft leader change in the past hour. Leadership may be flapping.";
          summary =
            "[Consul] Raft Leader alert";
        };
      }
    ];
  };
    ...
    rules = [
      {
        ...
        annotations = {
          description =
            "CPU has been above 90% on {{ $labels.host }} for more than 5 minutes.";
          summary =
            "[System] CPU Used alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Disk used on {{ $labels.host }} on mount / has been above 80% for more than 5 minutes.";
          summary =
            "[System] Disk used / alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Linear extrapolation predicts disk usage on {{ $labels.host }} will be above 90% within 12 hours.";
          summary =
            "[System] Predicted Disk used / alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Disk used on client {{ $labels.host }} /var has been above 80% for more than 5 minutes.";
          summary =
            "[System] Disk used Clients /var alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Linear extrapolation predicts client disk usage on /var on {{ $labels.host }} will be above 90% within 12 hours.";
          summary =
            "[System] Predicted Disk used clients /var alert on {{ $labels.host }}";
        };
      }
      {
        ...
        annotations = {
          description =
            "Memory used has been above 90% for more than 5 minutes.";
          summary =
            "[System] Memory Used alert on {{ $labels.host }}";
        };
      }
    ];
  };
