    ...
    rules = [
      {
        ...
        for = "15m";
        annotations = {
          summary = ''{{ $labels.job }} {{ $labels.route }} is experiencing {{ printf "%.2f" $value }}% errors in the past 15 minutes'';
      ...
      }
      {
        ...
        labels = {severity = "critical";};
        annotations = {
          summary = ''{{ $labels.job }} {{ $labels.route }} is experiencing {{ printf "%.2f" $value }}s 99th percentile latency for the past 15 minutes.'';
      ...
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = ''There are {{ printf "%f" $value }} unhealthy compactor(s) in the past 15 minutes.'';
      ...
      }
      {
        ...
        annotations = {
          summary = ''There are {{ printf "%f" $value }} unhealthy distributor(s) in the past 15 minutes.'';
      ...
      }
      {
        ...
        labels.severity = "warning";
        annotations = {
          summary = "Greater than 2 flush retries have occurred in the past hour.";
      ...
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = "Greater than 2 flush retries have failed in the past hour.";
          runbook_url = "https://github.com/grafana/tempo/tree/main/operations/tempo-mixin/runbook.md#TempoIngesterFlushesFailing";
        };
      }
      {
      ...
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = "No tenant index builders for tenant {{ $labels.tenant }} over the past 5 minutes. Tenant index will quickly become stale.";
      ...
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = "Tenant index age is 600 seconds old for tenant {{ $labels.tenant }}.";
      ...
      }
      {
        ...
        labels.severity = "warning";
        annotations = {
          summary = "{{ $labels.job }} failed to reload overrides.";
      ...
      }
      {
        ...
        labels.severity = "warning";
        annotations = {
          summary = "Ingesters in {{ $labels.cluster }}/{{ $labels.namespace }} are receiving more data/second than desired for the past 15 minutes.";
      ...
      }
      {
        ...
        labels.severity = "warning";
        annotations = {
          summary = "There are too many outstanding compaction blocks for tenant {{ $labels.tenant }} for the past 6 hours, increase compactor's CPU or add more compactors.";
      ...
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = "There are too many outstanding compaction blocks for tenant {{ $labels.tenant }} for the past 24 hours, increase compactor's CPU or add more compactors.";
          runbook_url = "https://github.com/grafana/tempo/tree/main/operations/tempo-mixin/runbook.md#TempoCompactorsTooManyOutstandingBlocks";
        };
      }
      {
        ...
        labels.severity = "critical";
        annotations = {
          summary = "Tempo ingester has encountered errors while replaying a block on startup for tenant {{ $labels.tenant }}";
