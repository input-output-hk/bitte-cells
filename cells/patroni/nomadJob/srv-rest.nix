{
  ...
  tags = [
    ...
    "traefik.http.routers.${namespace}-patroni-rest-api.entrypoints=http"
    "traefik.http.routers.${namespace}-patroni-rest-api.middlewares=corsheader@consulcatalog,${namespace}-patroni-rest-api-ratelimit@consulcatalog"
